...
//             {/* Feature Card 1 */}
//             <div className="group relative bg-gradient-to-br from-white to-primary-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-primary-100">
//               {/* Animated Gradient Border Effect */}
//               <div className="absolute inset-0 bg-gradient-to-r from-primary-500/30 via-purple-500/30 to-teal-500/30 rounded-2xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300 -z-10" />
...
//             {/* Feature Card 2 */}
//             <div className="group relative bg-gradient-to-br from-white to-purple-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-purple-100">
//               <div className="absolute inset-0 bg-gradient-to-r from-purple-500/30 via-primary-500/30 to-teal-500/30 rounded-2xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300 -z-10" />
...
//             {/* Feature Card 3 */}
//             <div className="group relative bg-gradient-to-br from-white to-teal-50 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-teal-100">
//               <div className="absolute inset-0 bg-gradient-to-r from-teal-500/30 via-primary-500/30 to-purple-500/30 rounded-2xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300 -z-10" />
